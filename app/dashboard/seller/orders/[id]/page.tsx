...
export default function SellerOrderDetailPage() {
  ...
  const handleMarkInProgress = async () => {
    ...
    try {
      ...
      setOrder((prev) => (prev ? { ...prev, status: 'in_progress' as const } : prev))
    ...
    return (
      <DashboardShell>
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <Link href="/dashboard/seller/orders" className="mt-4">
    ...
    <DashboardShell>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
          {/* Delivery Upload */}
          {showDeliveryUpload && canDeliver && (
            <DeliveryUpload orderId={order.id} onDelivered={handleDelivered} />
          )}
