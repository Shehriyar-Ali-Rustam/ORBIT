...
export const metadata: Metadata = {
  ...
  description:
    'ORBIT builds AI chatbots, custom ML models, web apps, mobile apps, and brand identity for clients worldwide. Pakistan-based software studio. Founder-led, fast delivery, world-class quality.',
  keywords: [
