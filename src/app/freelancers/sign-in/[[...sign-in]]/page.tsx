      ...
      <div className="flex min-h-[70vh] items-center justify-center px-6 py-12">
        <div className="max-w-md rounded-2xl border border-border bg-surface p-8 text-center">
          ...
          <p className="mt-3 text-sm text-text-secondary">
            ...
            <code className="rounded bg-surface-2 px-1.5 py-0.5 text-accent">CLERK_SECRET_KEY</code> in <code className="rounded bg-surface-2 px-1.5 py-0.5">.env.local</code> to enable sign-in.
          </p>
        </div>
      </div>
    )
