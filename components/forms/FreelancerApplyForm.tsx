...
export function FreelancerApplyForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div>
          <label htmlFor="role" className="mb-2 block text-sm font-medium text-white">Role *</label>
        ...
        <div>
          <label htmlFor="experience" className="mb-2 block text-sm font-medium text-white">Experience *</label>
      ...
      <div>
        <label htmlFor="skills" className="mb-2 block text-sm font-medium text-white">Skills *</label>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div>
          <label htmlFor="portfolioUrl" className="mb-2 block text-sm font-medium text-white">Portfolio URL *</label>
        ...
        <div>
          <label htmlFor="hourlyRate" className="mb-2 block text-sm font-medium text-white">Hourly Rate *</label>
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        <div>
          <label htmlFor="githubUrl" className="mb-2 block text-sm font-medium text-white">GitHub <span className="text-gray-2">(optional)</span></label>
          <input id="githubUrl" type="url" placeholder="https://github.com/..." className={inputClass} {...register('githubUrl')} />
        </div>
        <div>
          <label htmlFor="linkedinUrl" className="mb-2 block text-sm font-medium text-white">LinkedIn <span className="text-gray-2">(optional)</span></label>
          <input id="linkedinUrl" type="url" placeholder="https://linkedin.com/in/..." className={inputClass} {...register('linkedinUrl')} />
        </div>
        <div>
          <label htmlFor="fiverrUrl" className="mb-2 block text-sm font-medium text-white">Fiverr <span className="text-gray-2">(optional)</span></label>
          <input id="fiverrUrl" type="url" placeholder="https://fiverr.com/..." className={inputClass} {...register('fiverrUrl')} />
        </div>
      </div>

      <div>
        <label htmlFor="bio" className="mb-2 block text-sm font-medium text-white">Bio *</label>
      ...
      <div>
        <label htmlFor="hearAbout" className="mb-2 block text-sm font-medium text-white">How did you hear about us? <span className="text-gray-2">(optional)</span></label>
